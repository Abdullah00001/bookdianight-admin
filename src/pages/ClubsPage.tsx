...
import { mockClubs } from '@/features/clubs/api/mock';
...
export default function ClubsPage() {
  ...
  const filteredClubs = mockClubs.filter(club => club.status === activeTab);
    ...
    <div className="flex-1 space-y-8 p-8 pt-6">
      ...
      {filteredClubs.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center py-32 text-center">
          ...
          <p className="text-muted-foreground mt-2">There are currently no clubs in this category.</p>
        </div>
      )}
